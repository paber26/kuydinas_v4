                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        <a href="#"><i class="uil uil-estate"></i>Email</a>
                      </li>
                        ...
                        <li>
                          <a href="#"
                            ><img
                              ...
                              alt="edit"
                            />Draft<span
                              class="badge badge-primary badge-transparent"
                              >12</span
                            ></a
                          >
                        </li>
                        ...
                        <div class="add-lebel-from">
                          <form action="#">
                            ...
                            <div class="label-action d-flex button-group">
                              ...
                              <button
                                class="btn btn-white btn-sm btn-squared label-close"
                                data-trigger="label"
                              >
                                Cancel
                              </button>
              ...
              <div class="mailbox-container">
                ...
                <div class="mailbox-list">
                  <div class="card">
                    <div class="card-body">
                      <div
                        class="mailbox-top d-flex justify-content-between align-items-center"
                      >
                        <div class="mailbox-top__left">
                          <ul
                            class="mailbox-top__actions d-flex align-items-center"
                          >
                            <li
                              class="mail-selection checkbox-theme-default custom-checkbox"
                            >
                              <input
                                class="checkbox"
                                type="checkbox"
                        ...
                        <div
                          class="mailbox-top__right d-flex align-items-center"
                        >
                          ...
                          <div
                            class="mailbox-top__extra d-flex align-items-center"
                          >
                      ...
                      <div class="mailbox-list__content">
                        <div
                          class="mailbox-list__single d-flex justify-content-between"
                        >
                            ...
                            <div class="mail-content__top">
                              <h6 class="mail-title">
                                <a href="read-email.html"
                                  >Email subject lorem ipsum</a
                                >
                                <span
                                  class="badge badge-transparent badge-round"
                                  >Inbox</span
                                >
                              </h6>
                              <p>
                        ...
                        <div
                          class="mailbox-list__single d-flex justify-content-between attach-file"
                        >
                          <div class="mail-authorBox d-flex">
                            <div class="checkbox-theme-default custom-checkbox">
                              <input
